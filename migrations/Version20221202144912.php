 ...
 */
final class Version20221202144912 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE filters_websites_types (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE listing_projects_filters_websites_types (listing_projects_id INT NOT NULL, filters_websites_types_id INT NOT NULL, INDEX IDX_81F2C5694F939435 (filters_websites_types_id), INDEX IDX_81F2C56949C0D607 (listing_projects_id), PRIMARY KEY(listing_projects_id, filters_websites_types_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
